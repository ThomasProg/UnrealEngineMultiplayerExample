...
void AMultiplayerTestCharacter::UpdateAnimation()
{
...
void AMultiplayerTestCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Jump on any touch
	Jump();
}

void AMultiplayerTestCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Cease jumping once touch stopped
	StopJumping();
}

void AMultiplayerTestCharacter::UpdateCharacter()
{
